...
public class MarketsInfoDto {
	...
	public String toString() {
		return "MarketsInfoDto [bizesId=" + bizesId + ", bizesNm=" + bizesNm + ", brchNm=" + brchNm + ", indsLclsCd="
				+ indsLclsCd + ", indsLclsNm=" + indsLclsNm + ", indsMclsCd=" + indsMclsCd + ", indsMclsNm="
				+ indsMclsNm + ", indsSclsCd=" + indsSclsCd + ", indsSclsNm=" + indsSclsNm + ", ksicCd=" + ksicCd
				+ ", ksicNm=" + ksicNm + ", ctprvnCd=" + ctprvnCd + ", ctprvnNm=" + ctprvnNm + ", signguCd=" + signguCd
				+ ", signguNm=" + signguNm + ", adongCd=" + adongCd + ", adongNm=" + adongNm + ", ldongCd=" + ldongCd
				+ ", ldongNm=" + ldongNm + ", lnoCd=" + lnoCd + ", plotSctCd=" + plotSctCd + ", plotSctNm=" + plotSctNm
				+ ", lnoMnno=" + lnoMnno + ", lnoSlno=" + lnoSlno + ", lnoAdr=" + lnoAdr + ", rdnmCd=" + rdnmCd
				+ ", rdnm=" + rdnm + ", bldMnno=" + bldMnno + ", bldSlno=" + bldSlno + ", bldMngNo=" + bldMngNo
				+ ", bldNm=" + bldNm + ", rdnmAdr=" + rdnmAdr + ", oldZipcd=" + oldZipcd + ", newZipcd=" + newZipcd
				+ ", dongNo=" + dongNo + ", flrNo=" + flrNo + ", hoNo=" + hoNo + ", lon=" + lon + ", lat=" + lat + "]";
	}
